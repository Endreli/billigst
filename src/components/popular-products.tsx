...
const POPULAR = [
  ...
  { ean: "7038010009167", name: "Smor 500g", brand: "TINE" },
  { ean: "7622210100610", name: "Kvikk Lunsj", brand: "Kvikk Lunsj" },
  { ean: "7039610000127", name: "Egg 12pk", brand: "Prior" },
  { ean: "7090006990010", name: "Kjottdeig", brand: "Gilde" },
  { ean: "7310865068842", name: "Coca-Cola 1.5L", brand: "Coca-Cola" },
  { ean: "7035620001277", name: "Kneippbrod", brand: "Bakers" },
  { ean: "7040518400010", name: "Laks 400g", brand: "Leroy" },
];
      ...
      {POPULAR.map((p) => {
        ...
        return (
          <button
            ...
            className={`px-4 py-2.5 rounded-full text-[13px] font-medium transition-all active:scale-95 ${
              inBasket

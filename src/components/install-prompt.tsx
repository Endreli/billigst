    ...
    <div className="fixed top-18 left-4 right-4 z-40 max-w-lg mx-auto animate-slide-up sm:left-auto sm:right-4 sm:max-w-sm">
      <div className="bg-surface border border-border rounded-2xl p-4 shadow-2xl flex items-center gap-3">
        ...
        <div className="flex-1">
          <div className="text-white text-[15px] font-medium">Installer Billigst</div>
          <div className="text-text-muted text-[13px]">Legg til på hjemskjermen</div>
        </div>
        <button
          onClick={handleInstall}
          className="bg-primary text-white text-[13px] font-semibold px-4 py-2.5 rounded-xl hover:bg-primary-hover transition-colors active:scale-95"
        >
          Installer
        </button>
        <button

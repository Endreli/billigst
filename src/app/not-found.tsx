...
export default function NotFound() {
  return (
    <div className="text-center py-20 space-y-6 animate-fade-in">
      <div className="w-20 h-20 bg-surface rounded-2xl flex items-center justify-center mx-auto" aria-hidden="true">
      ...
      <div>
        <h1 className="text-3xl font-bold text-white">Siden ble ikke funnet</h1>
        <p className="text-text-muted text-[15px] mt-2 max-w-sm mx-auto">
          ...
          Prøv å søke etter produktet du er ute etter.
        </p>
      </div>

...
export default function HandlekurvPage() {
  ...
  useEffect(() => {
    if (lat && lng) {
      findNearbyStores(lat, lng).then(setNearbyStores);
    }
  }, [lat, lng]);
            ...
            <div className="space-y-2">
              ...
              {!hasLocation && !locationRequested && data.chainTotals.length > 1 && (
                ...
                >
                  ...
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#8b8fa3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
